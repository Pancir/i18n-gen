...
mod tests {
   use super::*;
   use crate::tr::service::StaticStrAccess;
   ...
   fn test_locals() {
      ...
      assert_eq!("hello world from group!", tr::group::hello().str());
      assert_eq!("hello Test from group!", tr::group::greet("Test").to_string());
      assert_eq!("number 42 and 52 from group!", tr::group::count(42, 52).to_string());
      ...
      assert_eq!("привет мир из группы!", tr::group::hello().str());
      assert_eq!("привет Тэст из группы!", tr::group::greet("Тэст").to_string());
      assert_eq!("число 42 и 52 из группы!", tr::group::count(42, 52).to_string());
   }
}
